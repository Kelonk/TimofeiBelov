...
public class ArticleControllerTestDB {
  ...
  void articleControllerTestAddList() throws Exception{
    ...
    HttpResponse<String> response = createArticles(service, objectMapper, List.of(
        new ArticleRecord("meow", Set.of("one", "two")),
        new ArticleRecord("meowmeow", Set.of("three", "-three"))));
